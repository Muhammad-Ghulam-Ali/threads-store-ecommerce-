...
//             </div>
//           </div>
//           <div className="image h-full w-full lg:w-[50%]">
...
//             <div className="grid gap-3" style={{ gridTemplateColumns: '1.8fr 1fr 1fr', height: '520px' }}>
...
//           {/* New Arrivals */}
//           <div className="bg-[#ede9e2] px-14 py-24 -mx-14">
//             <div className="flex items-end justify-between mb-12">
//               <div>
//                 <p className="text-[#c9a96e] text-[11px] uppercase tracking-[3px] mb-2">Hand picked</p>
//                 <h2 className="font-['Bebas_Neue'] text-[56px] leading-none tracking-[2px] text-[#0c0c0c]">NEW ARRIVALS</h2>
//               </div>
//               <Link to="/products" className="text-[#6e6e6e] text-[12px] font-semibold uppercase tracking-wide underline underline-offset-4 hover:text-[#0c0c0c]">View All →</Link>
//             </div>
...
//         </div>
//         <footer className="bg-[#0c0c0c] text-[#f4f1ec] px-14 py-20">
...
//             </div>
//           </div>
//           <div className="border-t border-[#1c1c1c] pt-7 flex justify-between items-center">
